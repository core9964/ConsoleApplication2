...
const EnemyData EnemyFactory::EnemyTable[] = {
	{1,"Slime",10,5,2,1,10,5,Element::None,5},
	{2,"Goblin",20,10,5,2,20,10,Element::Earth,10},
	{3,"Orc",30,15,8,3,30,15,Element::Fire,15},
	{4,"Dragon",100,50,20,5,1000,1000,Element::Wind,30},
};
